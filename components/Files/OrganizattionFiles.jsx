...
const OrganizationFiles = ({ enableScroll = true }) => {
    ...
    const data = [
        { id: '1', title: 'Outstation Travel Policy.pdf', file: "https://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf", author: 'Deepthi Komalangan', date: '17-Apr-2024', description: 'Dear All, Please find the attached outstation travel policy.\nThis policy will be effective from 5th April 2024.\nRegards,\nHr Team' },
